...
/**
 * Servlet implementation class listeDesTransfertsARecevoir
 */
@WebServlet("/listeDesTransfertsARecevoir")
public class listeDesTransfertsARecevoir extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public listeDesTransfertsARecevoir() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		transferList.RechercherTransfertARecevoir();
		...
		request.getRequestDispatcher("ResultatTransfertARecevoir.jsp").forward(request, response);
	}
